  ...
  return (
    <>
      <div className="max-w-7xl mx-auto pb-16">
        <h1 className="text-center text-4xl mb-10 font-bold text-blue-900 wow fadeInUp">
          Our Work Flow
        </h1>
        <div className="hidden md:block my-4 p-4 wow fadeInUp">
          <div className="flex items-center">
            <div className="flex items-center text-blue-900 relative">
              <div className="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-blue-900">
                <svg
              ...
              <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-blue-900">
                <h5 className="font-bold">STEP 1</h5>
                <p className="mt-1">DISCUSSING THE PROJECT WITH THE CLIENT</p>
              </div>
            </div>
            <div className="flex-auto border-t-2 transition duration-500 ease-in-out border-blue-900"></div>
            <div className="flex items-center text-blue-900 relative">
              <div className="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-blue-900">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-blue-900">
                ...
                <p className="mt-1">PLANING ACCORDING TO THE REQUIREMENT</p>
              </div>
            </div>
            <div className="flex-auto border-t-2 transition duration-500 ease-in-out border-blue-900"></div>
            <div className="flex items-center text-blue-900 relative">
              ...
              <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-blue-900">
                ...
                <p className="mt-1">HIRING SAILORS ACCORDINGLY</p>
              </div>
            </div>
            <div className="flex-auto border-t-2 transition duration-500 ease-in-out border-blue-900"></div>
            <div className="flex items-center text-blue-900 relative">
            ...
            <div className="flex items-center text-blue-900 relative">
              ...
              <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-blue-900">
                ...
                <p className="mt-1">DEPLOYING THEM TO EXECUTE</p>
              </div>
            </div>
            <div className="flex-auto border-t-2 transition duration-500 ease-in-out border-blue-900"></div>
            <div className="flex items-center text-blue-900 relative">
              ...
              <div className="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-blue-900">
                ...
                <p className="mt-1">DELIVERING QUALITY RESULTS</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="flex">
              <div className="flex flex-cols items-center justify-center py-4">
                <div className="rounded-full flex bg-blue-900 text-white h-14 w-14">
